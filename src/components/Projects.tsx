...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Ehajiri",
      description: "A complete attendance, HR, and payroll management system designed to streamline employee tracking, automate salary processing, and simplify organizational workflows with real-time insights.",
      image: "/ehajiri.png",
      // liveUrl: 'https://your-ehajiri-demo.vercel.app',
      // githubUrl: 'https://github.com/yourusername/ehajiri',
      ...
      features: [
        ...
        "Contribution Handling (PF, SSF, etc.)",
